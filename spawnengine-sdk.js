/* ============================================================
   SPAWNENGINE SDK v1.0 — Drop-In Widget Kit
...
(function () {
  ...
  .se-reveal{width:min(520px,92vw);border-radius:18px;background:linear-gradient(180deg, rgba(10,12,26,.98), rgba(5,6,14,.98));border:1px solid rgba(140,184,255,.55);box-shadow:0 30px 70px rgba(0,0,0,.75);overflow:hidden}
  ...
  .se-item{width:82px;height:72px;border-radius:12px;flex:0 0 auto;display:flex;flex-direction:column;justify-content:center;align-items:center;border:1px solid rgba(120,150,255,.22);background:linear-gradient(135deg, rgba(16,20,46,.92), rgba(6,8,18,.92))}
  ...
  function openReveal(opts = {}) {
    ...
    if (opts.autoOpen) setTimeout(spin, 200);
  }
